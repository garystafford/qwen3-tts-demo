...
class Qwen3TTSModel:
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        # Forward cache-related kwargs (e.g. local_files_only) to processor loading
        processor_kwargs = {k: v for k, v in kwargs.items() if k in ("local_files_only", "cache_dir", "token")}
        processor = AutoProcessor.from_pretrained(pretrained_model_name_or_path, fix_mistral_regex=True, **processor_kwargs)
